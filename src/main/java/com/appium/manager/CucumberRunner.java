...
public class CucumberRunner {
    ...
    public void triggerParallelCukes(String feature) throws IOException, InterruptedException {
        ...
        /*String[] a1 = new String[]{"java", "-cp \"" + classpPath +"\"", System.getProperty("user.dir") + "/target/classes:", System.getProperty("user.dir") + "/target/test-classes"
                , "cucumber.api.cli.Main", "--glue com.test.steps", System.getProperty("user.dir") + "/src/test/java/com/cucumber/features/" + feature, "--plugin json:", System.getProperty("user.dir") + "/target/" + feature + ".json"};
        p = Runtime.getRuntime().exec(new String[]{"java", "-cp \"" + classpPath +"\"", System.getProperty("user.dir") + "/target/classes:", System.getProperty("user.dir") + "/target/test-classes"
        , "cucumber.api.cli.Main", "--glue com.test.steps", System.getProperty("user.dir") + "/src/test/java/com/cucumber/features/" + feature, "--plugin json:", System.getProperty("user.dir") + "/target/" + feature + ".json"  });
        */Thread.sleep(2000);
